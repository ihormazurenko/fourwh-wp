...
add_filter( 'manage_product_option_posts_columns', function ( $columns ) {
	$my_columns = [
		'thumb' => 'Thumb',
	];
...
add_filter( 'manage_product_option_posts_columns', function ( $columns ) {
	...
	return array_slice( $columns, 0, 4 ) + $my_columns + $columns;
} );


add_action( 'manage_product_option_posts_custom_column', function ( $column_name ) {
